...
public class LANTests {
    ...
    private void YOUMAYWANTTOtestCompareFiles() {
        ...
        assertFalse(compareFiles(fName1, fName3), "not equals fName1 to fName3 (fName 3 is shorter)");
        assertFalse(compareFiles(fName3, fName1), "not equals fName3 to fName1  (fName 3 is shorter)");
        assertFalse(compareFiles(fName1, fName4), "not equals fName1 to fName4 (last character differs)");
        assertFalse(compareFiles(fName1, fName4), "not equals fName1 to fName4 (last character differs)");
    }
